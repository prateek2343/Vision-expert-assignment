        ...
        <div className="absolute left-0 top-0 w-full h-full bg-white dark:bg-slate-800 z-[55] rounded-md p-6 overflow-y-auto">
            ...
            <div>
                ...
                <div className="text-sm text-slate-600 dark:text-slate-300 font-normal">
                    ...
                    <br />
                    <br />
                    Jornalists call this critical, introductory section the
                    ...
                    <br />
                    <br />
                    posr with a bang With resrpect, i must disagree with
                    Mr.Zinsser. We all know the most part of important part of
                    any article is the title.Without a compelleing title, your
                    reader won't even get to the first sentence.After the title,
