        ...
        <div className=" space-y-5">
            <div className="grid xl:grid-cols-3 md:grid-cols-2 grid-cols-1 gap-5 card-height-auto">
                <Card title="Card Title" subtitle="Card Subtitle" noborder>
                    ...
                    <div className="text-sm">
                        ...
                        elit, sed do eiusmod tempor incididun ut .
                    </div>
            ...
            <div className="grid xl:grid-cols-4 md:grid-cols-2 grid-cols-1 gap-4 card-height-auto">
                ...
                <Card title="Sales Automation" noborder>
                    <div className="text-sm">
                        Lorem ipsum dolor sit amet, consec tetur adipiscing
                        elit, sed do eiusmod tempor incididun ut labore et dolor
                        magna aliqua.
                    </div>
                    ...
                    <div className="flex">
                        ...
                        <div className="flex-1">
                            <div className="mb-4 text-base">
                                ...
                                aliqua dolor do amet sintsin. Velit officia
                                consequat duis enim of velit mollit.”
                            </div>
                ...
                {cards.map((item, i) => (
                    <Card bodyClass="p-0" key={i} noborder>
                        ...
                        >
                            ...
                            <h6 className={`card-title mb-0  ${item.color}`}>
                                {item.title}
                            </h6>
                        </header>
