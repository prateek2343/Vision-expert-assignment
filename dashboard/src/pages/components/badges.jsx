        ...
        <div className="grid xl:grid-cols-2 grid-cols-1 gap-5">
            ...
            <Card title="Pill Badges">
                <div className="space-xy-5">
                    <Badge
                        label="primary"
                        className="bg-primary-500 text-white pill"
                    />
                    <Badge
                        label="secondary"
                    ...
                    <Badge
                        label="danger"
                        className="bg-danger-500 text-white pill"
                    />
                    <Badge
                        label="success"
                        className="bg-success-500 text-white pill"
                    />
                    <Badge
                        label="info"
                        className="bg-info-500 text-white pill"
                    />
                    <Badge
                        label="warning"
                        className="bg-warning-500 text-white pill"
                    />
                    <Badge
                        label="Dark"
